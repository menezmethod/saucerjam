...
Arena is the default overhead camera with a fixed angle and distance, smooth ship tracking, and no cursor-driven movement. V toggles Arena / full map. Chase, isometric, and zoom remain under Camera view in Flight menu. Portrait framing preserves a useful lateral view. Overhead segments show actual hull; PROTECTED means temporary spawn protection, not energy.
